...
L_CFLAGS += -DANDROID_P2P
#L_CFLAGS += -DRTW_USE_LAGACY_STA_EVENT		#for linux 2.6.35 compatible
#L_CFLAGS += -DRTL871X_HIDDEN_SSID_SUPPORT #Hidden ssid support of nl80211 for kernel version less than 3.4.0
endif
